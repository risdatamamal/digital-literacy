<!-- START: HEADER -->
<header class="{{ \Route::current()->getName() == 'home' ? 'absolute' : '' }} w-full z-50 px-4">
                ...
                <ul class="items-center flex">
                    <li class="ml-6 block md:hidden">
                        <button id="menu-toggler"
                            class="relative flex z-50 items-center justify-center w-8 h-8 text-black  {{ \Route::current()->getName() == 'home' ? 'md:text-white' : 'md:text-black' }} focus:outline-none">
