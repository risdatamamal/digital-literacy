<x-guest-layout>
    ...
    <section class="flex flex-col py-16">
        <div class="row flex flex-wrap justify-center gap-6">
            @foreach ($books as $book)
            <div class="col px-4 relative card group mb-4">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                    ...
                    <img src="{{ $book->cover ? Storage::url($book->cover) : url('img/no-cover.png')}}" alt=""
