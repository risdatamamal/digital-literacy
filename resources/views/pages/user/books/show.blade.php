            ...
            <div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea type="text" rows="25" id="editor" readonly class="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="content" >{{ $book->content }}</textarea>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <form class="hidden" id="rating" action="{{ route('user.books.rating.set', $book->id) }}" method="POST" >
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="" name="value" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" placeholder="5">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 text-right">
                ...
                <form class="hidden" id="comment" action="{{ route('user.books.comment.store', $book->id) }}" method="POST" >
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="user_id" value="{{ $book->user->id }}">
                    <input type="hidden" name="book_id" value="{{ $book->id }}">
