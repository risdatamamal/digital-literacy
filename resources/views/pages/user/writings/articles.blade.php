    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10 flex flex-row justify-between">
                <a href="{{ route('user.articles.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-lg">
                    + Write an Article
                </a>
                <form class=" items-center flex flex-row justify-between" action="{{ route('user.writing.articles') }}" method="GET">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md mb-4 max-w-7xl">
                        <a href="{{ route('user.articles.show', $article->id) }}">
                            <div class="px-4 py-5 bg-white sm:p-6 flex flex-row justify-between">
                                <div class="flex-col">
                                    <img src="{{ $article->cover ??  'https://perpustakaan.bsn.go.id/images/no-cover.png'}}" class="w-[244px] h-[244px]" height="300" width="300">
