<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('articles.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-lg">
                    + Create Article
                </a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-evenly">
                                            ...
                                            <form class="inline-block" action="{{ route('articles.destroy', $article->id) }}" method="POST">
